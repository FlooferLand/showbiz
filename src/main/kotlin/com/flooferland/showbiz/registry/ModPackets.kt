...
sealed class ModPackets<T: CustomPacketPayload> {
    ...
    data object ShowFileEdit : ModPackets<ShowFileEditPacket>(ClientToServer, ShowFileEditPacket.type, ShowFileEditPacket.codec)
    data object AudioUploadChunk : ModPackets<AudioUploadChunkPacket>(ClientToServer, AudioUploadChunkPacket.type, AudioUploadChunkPacket.codec)
    data object AudioUploadHeader : ModPackets<AudioUploadHeaderPacket>(ClientToServer, AudioUploadHeaderPacket.type, AudioUploadHeaderPacket.codec)
    data object AudioUploadResponse : ModPackets<AudioUploadResponsePacket>(ServerToClient, AudioUploadResponsePacket.type, AudioUploadResponsePacket.codec)
