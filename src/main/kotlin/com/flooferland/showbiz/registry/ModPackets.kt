...
sealed class ModPackets<T: CustomPacketPayload> {
    ...
    data object FileUploadChunk : ModPackets<FileUploadChunkPacket>(ClientToServer, FileUploadChunkPacket.type, FileUploadChunkPacket.codec)
    data object FileUploadHeader : ModPackets<FileUploadHeaderPacket>(ClientToServer, FileUploadHeaderPacket.type, FileUploadHeaderPacket.codec)
    data object FileUploadResponse : ModPackets<FileUploadResponsePacket>(ServerToClient, FileUploadResponsePacket.type, FileUploadResponsePacket.codec)
