...
class ShowParserEditScreen(val editMenu: ShowParserEditMenu, inventory: Inventory, title: Component) : Screen(title), MenuAccess<ShowParserEditMenu> {
    ...
    val background = rl("textures/gui/show_parser.png")
    ...
    override fun renderBackground(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        val menuOwner = Minecraft.getInstance()?.level?.getBlockState(editMenu.data.blockPos)
